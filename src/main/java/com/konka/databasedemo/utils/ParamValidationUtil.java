...
public class ParamValidationUtil {
     ...
     * @throws BusinessException
     */
    public static void checkOneByOne(Object param, int exceptionCode, String exceptionMsg) throws BusinessException {
        ...
        if (violationList.size() > 0) {
            ...
            stringBuffer.append("[");
            stringBuffer.append(violationList.get(0).getMessage());
            stringBuffer.append("]");
            throw new BusinessException(exceptionCode, stringBuffer.toString());
        }
