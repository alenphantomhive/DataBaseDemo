...
<generatorConfiguration>
    ...
    <classPathEntry location="${base.db.driverLocation}" />
    ...
    <context id="testTables" targetRuntime="MyBatis3">
        ...
        <javaModelGenerator targetPackage="${base.basePackageName}.model.po" targetProject="${base.mbg.targetProject}">
        ...
        -->
        <javaClientGenerator type="ANNOTATEDMAPPER" targetPackage="${base.basePackageName}.mapper" targetProject="${base.mbg.targetProject}">
